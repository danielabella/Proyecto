...
import Modelos.ProductoOperacion;
...
public class AgregarController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Producto p = new Producto(cod_art, descripcion, provedor, cantidad, precio_compra, precio_venta);
        ProductoOperacion po = new ProductoOperacion();
        po.agregarProducto(p);
