        ...
        <div class="card m-5">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                          <input type="text" class="form-control" id="cod_art" placeholder="Cod articulo" name="cod_art">
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                          <input type="text" class="form-control" id="provedor" placeholder="Provedor" name="provedor">
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                          <input type="number" class="form-control" id="precio_compra" placeholder="Precio compra" name="precio_compra">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="precio_venta" class="col-sm-2 col-form-label">Precio venta</label>
                      <div class="col-sm-10">
                          <input type="number" class="form-control" id="precio_venta" placeholder="Precio venta" name="precio_venta">
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-sm-10">
